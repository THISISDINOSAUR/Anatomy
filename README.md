...
- Texturing
Currently little thoughts on the best way to do texturing. May use some sort of masking system, with the similar tools to the other details (e.g. spikes), for things like varying stripes.
